...
* File bug reports and feature requests in the `issue tracker
  <https://github.com/emcd/python-classcore/issues>`_. (Please try
  to avoid duplicate issues.)

* Fork the repository and submit `pull requests
  <https://github.com/emcd/python-classcore/pulls>`_ to improve the
...
* The architecture documentation in `sources/classcore/README.md` should be
